...
; przechowanie używanych rejestrów
 ...
 mov ax, cs:licznik_przerwan
 add ax, 1
 mov cs:licznik_przerwan, ax
 
 cmp ax, 18
 
 jnz pomin_przerwanie
 
 mov cs:licznik_przerwan, dword PTR 0
...
; począwszy od adresu fizycznego 8 * 4 = 32)
 ...
 mov cs:wektor8, eax
 mov cs:licznik_przerwan, dword PTR 0 ;inicjalzacja licznika przerwan, chcemy rysować gwiazdkę co ok 1s czyli co 18 przerwań zegarowych
