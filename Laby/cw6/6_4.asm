...
rozkazy SEGMENT use16
 ASSUME CS:rozkazy 
;============================================================
;procedura wyświetlania liczby z rejestru AL
...
; wpisanie do wektora nr 9 adresu procedury 'przerwanie_klawiatury'
 mov ax, SEG przerwanie_klawiatury ; część segmentowa adresu
 mov bx, OFFSET przerwanie_klawiatury ; offset adresu
